...
goto_chadshomeimprovement_app
  perform_contractor_search_with_no_criteria
  @contractor_search_criteria = contractor_search_with_no_criteria
end
...
Then(/^No contractors are displayed in the list of contractors screen$/) do
  ...
  expect(contractor_search_results).to be_empty
end

When(/^When user searches for contractors using one criteria$/) do
  # perform contractor search using one search criteria
end
...
When(/^When user searches for contractors using two criteria$/) do
  # perform contractor search using two search criteria
